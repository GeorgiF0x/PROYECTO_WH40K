...
export const CATEGORIES = [
  { id: 'all', label: 'Todas', icon: null },
  {
    id: 'marines',
    label: 'Marines',
    icon: '/icons/Imperium/Adeptus Astartes [Imperium, Space Marines].svg',
  },
  ...
  { id: 'imperium', label: 'Imperium', icon: '/icons/Imperium/Adeptus Terra [Imperium].svg' },
  {
    id: 'aeldari',
    label: 'Aeldari',
    icon: '/icons/Xenos/Aeldari/Aeldari [Eldar, Eye of Asuryan, Gods].svg',
  },
  {
    id: 'tyranids',
    label: 'Tiránidos',
    icon: '/icons/Xenos/Tyranid/Tyranids [Hive Mind, Hive Fleets].svg',
  },
...
export const SLUG_TO_CATEGORY: Record<string, string> = {
  // Marines
  ultramarines: 'marines',
  'blood-angels': 'marines',
  'dark-angels': 'marines',
  'space-wolves': 'marines',
  'imperial-fists': 'marines',
  salamanders: 'marines',
  'raven-guard': 'marines',
  'iron-hands': 'marines',
  'white-scars': 'marines',
  'black-templars': 'marines',
  'crimson-fists': 'marines',
  'flesh-tearers': 'marines',
  deathwatch: 'marines',
  'blood-ravens': 'marines',
  lamenters: 'marines',
  minotaurs: 'marines',
  ...
  'world-eaters': 'chaos',
  'chaos-daemons': 'chaos',
  'khorne-daemons': 'chaos',
  'nurgle-daemons': 'chaos',
  'tzeentch-daemons': 'chaos',
  'slaanesh-daemons': 'chaos',
  'chaos-knights': 'chaos',
  // Imperium
  ...
  armageddon: 'imperium',
  valhallan: 'imperium',
  'martyred-lady': 'imperium',
  'bloody-rose': 'imperium',
  'ebon-chalice': 'imperium',
  'argent-shroud': 'imperium',
  'sacred-rose': 'imperium',
  'valorous-heart': 'imperium',
  // Aeldari
  aeldari: 'aeldari',
  drukhari: 'aeldari',
  ulthwe: 'aeldari',
...
export const FACTION_ICONS: Record<string, string> = {
  ...
  ultramarines:
    '/icons/Imperium/Ultramarines [Imperium, Adeptus Astartes, Space Marines, Legion].svg',
  'blood-angels':
    '/icons/Imperium/Blood Angels [Imperium, Adeptus Astartes, Space Marines, Legion].svg',
  'dark-angels':
    '/icons/Imperium/Dark Angels [Imperium, Adeptus Astartes, Space Marines, Legion].svg',
  'space-wolves':
    '/icons/Imperium/Space Wolves [Imperium, Adeptus Astartes, Space Marines, Legion].svg',
  'imperial-fists':
    '/icons/Imperium/Imperial Fists [Imperium, Adeptus Astartes, Space Marines, Legion].svg',
  salamanders:
    '/icons/Imperium/Salamanders [Imperium, Adeptus Astartes, Space Marines, Legion].svg',
  'raven-guard':
    '/icons/Imperium/Raven Guard [Imperium, Adeptus Astartes, Space Marines, Legion].svg',
  'iron-hands':
    '/icons/Imperium/Iron Hands [Imperium, Adeptus Astartes, Space Marines, Legion].svg',
  'white-scars':
    '/icons/Imperium/White Scars [Imperium, Adeptus Astartes, Space Marines, Legion].svg',
  // Capítulos sucesores con icono propio
  'black-templars':
    '/icons/Imperium/Black Templars [Imperium, Adeptus Astartes, Space Marines, Imperial Fists, Chapter].svg',
  'grey-knights':
    '/icons/Imperium/Grey Knights [Imperium, Inquisition, Ordo Malleus, Adeptus Astartes, Space Marines, Chapter].svg',
  deathwatch:
    '/icons/Imperium/Deathwatch [Imperium, Inquisition, Ordo Xenos, Adeptus Astartes, Space Marines, Chapter].svg',
  'blood-ravens':
    '/icons/Imperium/Blood Ravens [Imperium, Adeptus Astartes, Space Marines, Chapter].svg',
  'flesh-tearers':
    '/icons/Imperium/Flesh Tearers [Imperium, Adeptus Astartes, Space Marines, Blood Angels, Chapter].svg',
  lamenters:
    '/icons/Imperium/Lamenters [Imperium, Adeptus Astartes, Space Marines, Blood Angels, Chapter].svg',
  minotaurs:
    '/icons/Imperium/Minotaurs [Imperium, Adeptus Astartes, Space Marines, High Lords of Terra, Chapter].svg',
  ...
  'adepta-sororitas':
    '/icons/Imperium/Adepta Sororitas [Imperium, Adeptus Ministorum, Ecclesiarchy, Inquisition, Ordo Hereticus, Sisters of Battle, Battle Sisters].svg',
  'astra-militarum': '/icons/Imperium/Astra Militarum [Imperium, Imperial Guard].svg',
  'imperial-knights':
    '/icons/Imperium/Imperial Knights [Imperium, Questor Imperialis, Questoris Knights].svg',
  'agents-imperium': '/icons/Imperium/Adeptus Terra [Imperium].svg',
  // Órdenes de Sororitas con icono propio
  'martyred-lady':
    '/icons/Imperium/Order of Our Martyred Lady [Imperium, Adeptus Ministorum, Ecclesiarchy, Adepta Sororitas , Sisters of Battle, Battle Sisters, Order].svg',
  'bloody-rose':
    '/icons/Imperium/Order of the Bloody Rose [Imperium, Adeptus Ministorum, Ecclesiarchy, Adepta Sororitas , Sisters of Battle, Battle Sisters, Order].svg',
  'ebon-chalice':
    '/icons/Imperium/Order of the Ebon Chalice [Imperium, Adeptus Ministorum, Ecclesiarchy, Adepta Sororitas , Sisters of Battle, Battle Sisters, Order].svg',
  'argent-shroud':
    '/icons/Imperium/Order of the Argent Shroud [Imperium, Adeptus Ministorum, Ecclesiarchy, Adepta Sororitas , Sisters of Battle, Battle Sisters, Order].svg',
  'valorous-heart':
    '/icons/Imperium/Order of the Valorous Heart [Imperium, Adeptus Ministorum, Ecclesiarchy, Adepta Sororitas , Sisters of Battle, Battle Sisters, Order].svg',
  ...
  // ========== CHAOS ==========
  'black-legion':
    '/icons/Chaos/Black Legion [Chaos, Heretic Astartes, Chaos Space Marines, Legion].svg',
  'death-guard':
    '/icons/Chaos/Death Guard [Chaos, Heretic Astartes, Chaos Space Marines, Legion, Nurgle].svg',
  'thousand-sons':
    '/icons/Chaos/Thousand Sons [Chaos, Heretic Astartes, Chaos Space Marines, Legion, Tzeentch].svg',
  'world-eaters':
    '/icons/Chaos/World Eaters [Chaos, Heretic Astartes, Chaos Space Marines, Legion, Khorne].svg',
  'alpha-legion':
    '/icons/Chaos/Alpha Legion [Chaos, Heretic Astartes, Chaos Space Marines, Legion].svg',
  'iron-warriors':
    '/icons/Chaos/Iron Warriors [Chaos, Heretic Astartes, Chaos Space Marines, Legion].svg',
  'night-lords':
    '/icons/Chaos/Night Lords [Chaos, Heretic Astartes, Chaos Space Marines, Legion].svg',
  'word-bearers':
    '/icons/Chaos/Word Bearers [Chaos, Heretic Astartes, Chaos Space Marines, Legion].svg',
  'emperors-children':
    '/icons/Chaos/Emperor_s Children [Chaos, Heretic Astartes, Chaos Space Marines, Legion, Slaanesh].svg',
  'sons-of-horus':
    '/icons/Chaos/Sons of Horus [Chaos, Heretic Astartes, Chaos Space Marines, Legion].svg',
  'chaos-space-marines': '/icons/Chaos/Heretic Astartes [Chaos, Chaos Space Marines].svg',
  'chaos-knights':
    '/icons/Chaos/Questor Traitoris [Chaos, Dark Mechanicum, Chaos Knights, Renegade Knights].svg',
  ...
  'genestealer-cults':
    '/icons/Xenos/Genestealer Cult/Genestealer Cults [Hive Mind, Tyranids, Genestealers].svg',
  ...
  'farsight-enclaves':
    '/icons/Xenos/Tau/Farsight Enclaves [T_au_va, Greater Good, T_au, Renegades].svg',
...
export function FactionSelector({
  ...
  return (
    <div className="space-y-4">
      ...
      <motion.div layout className="flex min-h-[40px] flex-wrap gap-2">
        <AnimatePresence mode="popLayout">
          {selectedFactionDetails.map((faction, index) => (
            ...
            >
              ...
              <span className="font-body text-xs text-bone">{faction.name}</span>
              <X className="h-3 w-3 text-bone/50 hover:text-bone" />
            </motion.button>
          ))}
        </AnimatePresence>

        {selectedFactions.length === 0 && (
          <span className="self-center font-body text-xs text-bone/40">
      ...
      {/* Faction grid */}
      <div className="scrollbar-thin scrollbar-thumb-bone/20 h-[180px] overflow-y-auto pr-1">
                ...
                className={`relative rounded-xl border p-3 text-left transition-all ${
                  isSelected
                    ...
                    : canSelect
                      ...
                      : 'cursor-not-allowed border-bone/5 opacity-40'
                }`}
                style={{
                ...
                <div className="flex items-center gap-2">
                  ...
                  {isSelected && (
                    <motion.div
                      initial={{ scale: 0 }}
                      animate={{ scale: 1 }}
                      className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-imperial-gold text-[10px] font-bold text-void"
                    >
