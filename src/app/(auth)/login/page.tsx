...
function LoginForm() {
  ...
  return (
    <>
      <AnimatePresence>
        {showBoot && <BootSequence onComplete={() => router.push(redirect)} />}
      </AnimatePresence>
      <motion.div
          ...
          <div className="relative rounded-xl bg-gradient-to-b from-void-light to-void p-8 backdrop-blur-sm">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              ...
              <motion.div variants={itemVariants}>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full rounded-lg border-2 bg-void py-3.5 pl-12 pr-4 font-body text-bone outline-none transition-all duration-300 placeholder:text-bone/30 ${
                      errors.email
              ...
              <motion.div variants={itemVariants} className="flex justify-end">
                <Link
                  ...
                  className="font-body text-sm text-bone/50 transition-colors hover:text-imperial-gold"
                >
            ...
            <motion.div variants={itemVariants} className="grid grid-cols-2 gap-4">
              ...
              <motion.button
                ...
                disabled={isLoading}
                className="group flex items-center justify-center gap-2 rounded-lg border border-bone/10 bg-white/5 px-4 py-3 text-bone transition-all hover:border-bone/20 hover:bg-white/10 disabled:opacity-50"
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
              >
              ...
              <motion.button
                ...
                disabled={isLoading}
                className="group flex items-center justify-center gap-2 rounded-lg border border-[#5865F2]/30 bg-[#5865F2]/10 px-4 py-3 text-[#5865F2] transition-all hover:border-[#5865F2]/50 hover:bg-[#5865F2]/20 disabled:opacity-50"
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
              >
