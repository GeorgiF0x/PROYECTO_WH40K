...
>(({ className, ...props }, ref) => (
  <CommandPrimitive
    ref={ref}
    className={cn(
      'flex h-full w-full flex-col overflow-hidden rounded-lg bg-[hsl(240,10%,6%)] text-bone',
      className
    )}
    {...props}
  />
...
>((props, ref) => (
  <CommandPrimitive.Empty
    ref={ref}
    className="py-6 text-center text-sm text-bone/50"
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Group
    ref={ref}
    className={cn(
      'overflow-hidden p-1 text-bone [&_[cmdk-group-heading]]:px-2 [&_[cmdk-group-heading]]:py-1.5 [&_[cmdk-group-heading]]:text-xs [&_[cmdk-group-heading]]:font-medium [&_[cmdk-group-heading]]:text-bone/50',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Item
    ...
    className={cn(
      ...
      'data-[selected=true]:bg-bone/10 data-[selected=true]:text-bone',
...
const CommandShortcut = ({
  ...
  return (
    <span
      className={cn(
        'ml-auto text-xs tracking-widest text-bone/40',
        className
      )}
      {...props}
    />
